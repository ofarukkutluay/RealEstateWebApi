...
namespace RealEstateWebApi.Persistence.Migrations
{
    ...
    [Migration("20220529155111_mig_1")]
    partial class mig_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstateWebApi.Domain.Entities.OperationClaim", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RealEstateWebApi.Domain.Entities.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RealEstateWebApi.Domain.Entities.Agent", b =>
                {
                    ...
                    b.HasOne("RealEstateWebApi.Domain.Entities.User", null)
                        .WithOne()
            ...
            modelBuilder.Entity("RealEstateWebApi.Domain.Entities.User", b =>
                {
                    b.HasOne("RealEstateWebApi.Domain.Entities.OperationClaim", null)
                        .WithMany()
